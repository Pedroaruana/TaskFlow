    ...
    <div className="grid grid-cols-1 md:grid-cols-2 min-h-screen">
      ...
      <main className='flex items-center justify-center p-10'>
        <section className='w-full max-w-sm'>
          <header>
            <h1 className='text-3xl font-bold' id="titleLogin">Verifique seu código</h1>
            <p className='text-gray-500 mt-1'>Digite o código de 6 dígitos que enviamos para seu email.</p>
          </header>

          <form className='mt-6 space-y-4' onSubmit={handleSubmit}>
            <label htmlFor="otp" className='text-gray-700 text-sm font-medium'>Código OTP</label>
            <div className="relative">
              ...
              <input
                ...
                placeholder='000000'
                className="w-full rounded-lg border border-gray-300 pl-8 h-10 tracking-[0.5em]"
              />
            </div>
            <p className="text-red-500 text-xs min-h-[1rem]" role="alert"></p>

            <ButtonDefault type="submit">Verificar OTP</ButtonDefault>
          </form>

          <footer className="flex items-center justify-center gap-1 mt-4 text-sm">
            <Link to="/esqueci-minha-senha" className="text-[#4F378A] font-medium">
